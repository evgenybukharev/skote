...
@if ($crud->fieldTypeNotLoaded($field))
    ...
    @push('crud_fields_scripts')
        <script src="{{ asset('assets/vendor/skote/libs/cropperjs/cropperjs.min.js') }}"></script>
        <script src="{{ asset('assets/vendor/skote/libs/jquery-cropper/jquery-cropper.min.js') }}"></script>
        <script>
