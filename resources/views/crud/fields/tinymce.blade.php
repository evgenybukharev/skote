...
@include('skote::crud.fields.inc.wrapper_start')
    ...
    <textarea
        ...
        @include('skote::crud.fields.inc.attributes', ['default_class' =>  'form-control tinymce'])
...
@if ($crud->fieldTypeNotLoaded($field))
    ...
    <!-- include tinymce js-->
    <script src="{{ asset('assets/vendor/skote/libs/tinymce/tinymce.min.js') }}"></script>
    ...
    function elFinderBrowser (callback, value, meta) {
        tinymce.activeEditor.windowManager.openUrl({
            title: 'elFinder 2.0',
            url: '{{ skote_url('elfinder/tinymce5') }}',
            width: 900,
            height: 460,
