    ...
    <div class="controls">
	    <div class="input-group">
			...
			<span class="input-group-append">
			  	<button type="button" data-inputid="{{ $field['name'] }}-filemanager" class="btn btn-light btn-sm popup_selector"><i class="bx bxs-cloud-upload"></i> {{ trans('skote::crud.browse_uploads') }}</button>
				<button type="button" data-inputid="{{ $field['name'] }}-filemanager" class="btn btn-light btn-sm clear_elfinder_picker"><i class="bx bx-reset"></i> {{ trans('skote::crud.clear') }}</button>
			</span>
		</div>
	</div>
