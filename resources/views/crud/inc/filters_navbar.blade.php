<div class="row">
    <div class="col-12">
        <nav class="navbar navbar-expand-lg navbar-filters m-0 pl-0 pb-10 pt-10">
            <!-- Brand and toggle get grouped for better mobile display -->
            <a class="nav-item d-none d-lg-block"><span class="la la-filter"></span></a>
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#bp-filters-navbar" aria-controls="bp-filters-navbar" aria-expanded="false" aria-label="{{ trans('skote::crud.toggle_filters') }}">
                <span class="la la-filter"></span> {{ trans('skote::crud.filters') }}
            </button>
            ...
            <div class="collapse navbar-collapse" id="bp-filters-navbar">
                <ul class="nav navbar-nav">
                    ...
                    @endforeach
                    <li class="nav-item"><a href="#" id="remove_filters_button" class="nav-link {{ count(Request::input()) != 0 ? '' : 'invisible' }}"><i class="la la-eraser"></i> {{ trans('skote::crud.remove_filters') }}</a></li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
    </div>
