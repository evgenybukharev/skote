...
namespace EvgenyBukharev\Skote\Crud\Controllers\Operations;
...
trait ShowOperation
{
    ...
    protected function setupShowDefaults()
    {
        ...
        $this->crud->operation('list', function () {
            $this->crud->addButton('line', 'show', 'view', 'skote::crud.buttons.show', 'beginning');
        });
        ...
        $this->crud->operation(['create', 'update'], function () {
            $this->crud->addSaveAction([
                ...
                'button_text' => trans('skote::crud.save_action_save_and_preview'),
            ]);
        });
    }
    ...
    public function show($id)
    {
        ...
        $this->data['title'] = $this->crud->getTitle() ?? trans('skote::crud.preview').' '.$this->crud->entity_name;
