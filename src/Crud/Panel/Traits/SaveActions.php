    ...
    public function setupDefaultSaveActions()
    {
        $defaultSaveActions = [
            [
                ...
                'button_text' => trans('skote::crud.save_action_save_and_back'),
            ],
            [
                'name' => 'save_and_edit',
                'visible' => function ($crud) {
                ...
                'button_text' => trans('skote::crud.save_action_save_and_edit'),
            ],
            [
                'name' => 'save_and_new',
                'visible' => function ($crud) {
                ...
                'button_text' => trans('skote::crud.save_action_save_and_new'),
            ],
        ];
