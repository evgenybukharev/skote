 ...
 * - skote::crud.addButton('top', 'create', 'view', 'skote::crud.buttons.create');
 *
 * Developers can also do:
 * - skote::crud.button('create')->stack('top')->view('skote::crud.buttons.create');
 *
 * And if the developer uses CrudButton as Button in their CrudController:
 * - Button::name('create')->stack('top')->view('skote::crud.butons.create');
 */
class CrudButton
{
    public $stack;
     ...
     *
     * @return \EvgenyBukharev\Skote\Crud\Panel\CrudPanel
     */
